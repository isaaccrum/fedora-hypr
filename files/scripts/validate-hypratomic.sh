...
for name in bootstrap activate restore doctor session clipboard screenshot coding-bootstrap keybinds theme wallpaper quickshell launcher power-menu; do
