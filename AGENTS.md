...
- Preserve Wayblue session integration and avoid duplicate service startup. Quickshell is the default session shell; keep Waybar available as a known-good explicit fallback. Do not activate desktop configuration during image deployment.
