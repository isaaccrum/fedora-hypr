...
- [ ] Quickshell appears once; network, notifications, audio, and screen sharing work.
...
- [ ] Waybar fallback works with `hypratomic-session --waybar`; no binding depends on Kitty.
